...
import { RiArrowRightLine, RiSendPlaneFill } from 'react-icons/ri'
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="bg-gray/20 p-6 rounded-lg">
          <div className="text-gray-400 mb-4">Price Chart</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-gray/20 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={`${parseFloat(crypto.percent_change_1h) >= 0 ? 'text-green-400' : 'text-red-400'
                } font-medium`}>
          ...
          <div className="bg-gray/20 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={`${parseFloat(crypto.percent_change_24h) >= 0 ? 'text-green-400' : 'text-red-400'
                } font-medium`}>
          ...
          <div className="bg-gray/20 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={`${parseFloat(crypto.percent_change_7d) >= 0 ? 'text-green-400' : 'text-red-400'
                } font-medium`}>
